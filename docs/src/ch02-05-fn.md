...
Returns an [`Option`](ch02-03-option.md) that, if the provided index points to a concrete argument,
contains a [`SmartPointer`](ch02-02-smart-pointer.md) to the argument.
